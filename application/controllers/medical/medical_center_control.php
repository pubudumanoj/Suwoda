 ...
 */
class Medical_center_control extends CI_Controller {
    ...
    public function index() {
         ...
         * 
         */
        $result = $this->view_centers($this->type, $searchkey, $this->offset);
    ...
    public function view_centers($type, $searchkey, $offset) {

        return $this->medical_center_model->view_centers($type, $searchkey, $offset);
    }

    public function load_view($result, $type, $search, $offset, $current_offset, $total_count) {
        $data['title'] = ucfirst('View Centres');
        $data['result'] = $result;
        ...
        $this->load->view('medical/medical', $data);
