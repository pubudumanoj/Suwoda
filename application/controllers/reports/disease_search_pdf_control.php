 ...
 * 
 */
class Disease_search_pdf_control extends CI_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        $this->load->model('reports/Disease_search_pdf_model');
    ...
    function disease_by_month($year) {
        ...
        return $this->Disease_search_pdf_model->disease_by_month($year);
    }

    function disease_cat_by_year($year) {
        /*
         * count diseases for each disease name in a given year
         */

        return $this->Disease_search_pdf_model->disease_cat_by_year($year);
    }
    ...
    function disease_by_range($date1, $date2) {
        ...
        return $this->Disease_search_pdf_model->disease_by_range($date1, $date2);
    }
    ...
    public function generate_disease_reports() {
        ...
        if ($this->input->post('disease_by_month')) {
            ...
            <h4>Searched diseases count by month for year <?php echo $year ?></h4>
        ...
        if ($this->input->post('disease_by_year')) {
            ...
            <h4>Searched diseases count by disease name for year <?php echo $year ?></h4>
            <table style="margin:2px;padding:5px;
                   width:50%;
                   box-shadow: 10px 10px 5px #888888;
                   border:1px solid #3f7f00;
        ...
        if ($this->input->post('disease_by_range')) {
            ...
            <h4>Searched diseases count by name from <?php echo $date1 ?> to <?php echo $date2 ?> </h4>
            <table style="margin:2px;padding:5px;
                   width:50%;
                   box-shadow: 10px 10px 5px #888888;
                   border:1px solid #3f7f00;
        ...
        $pdf->Output('disease_search_stats.pdf', 'I');
    }
