...
<?php 
$attributes = array('class' => 'form-container', 'id' => 'signup-form'); 
echo form_open("registration/edit_control/registration",$attributes); ?>
           
       <div class="form-title"><h2>Sign Up</h2></div> 
          <div class="form-title">First Name:
            <input class="form-field" type="text" id="fname" name="fname" value="<?php echo $prof_data['fname'] ?>" />
          </div>
        <div class="form-title">Last Name:
            <input class="form-field"type="text" id="fname" name="lname" value="<?php echo $prof_data['lname'] ?>" />
        </div>
       <div class="form-title">Gender:
            <input type="radio" id="gender" name="gender" value="1" <?php if ($prof_data['gender']==1) {
echo 'checked';    
}?>>Male
            <input type="radio" id="gender" name="gender" value="2" <?php if ($prof_data['gender']==2) {
echo 'checked';    
}?>>Female
       </div>
        <div class="form-title">Birth day:
            <input class="form-field" type="date" id="bdate" name="bdate" value="<?php echo $prof_data['bdate'] ?>" />
        </div>
 ...
 <div class="form-title">Current Password:
     <input class="form-field" for="cur_pword" type="password" id="cur_pword" name="cur_pword"  />
 </div>
          <div class="form-title">Password:
              <input class="form-field" type="password" id="pword" name="pword"  />
          </div>
    ...
    <div class="submit-container">
            <input class="greenButton submit-button" type="submit" class="greenButton" value="Update" />
    </div>
        <?php echo form_close(); ?>
