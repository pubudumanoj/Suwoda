    ...
    <div class='body-left'>
        ...
        <?php if ($logged_in && $role == 1) {
            ...
            <?php
                ...
                echo form_open("medical/medical_center_edit_control/validate_Information", $attributes);
                ?>
                <div>
                    <div class="form-container" style="float: left">
                        <div class="form-title"><h2>Edit Medical Center Details</h2></div>
                        <div class="form-title">
                             <input type="hidden" name="center_id" value="<?php echo $result[0]->center_id; ?>">
                            Name of the Center: 
                            <input type="text" id="center_name" name="center_name" class="form-field" value="<?php echo $result[0]->name; ?>" required/>
                        </div>
                        <div class="form-title">
                            Type of the Center:
                        ...
                        <div class="form-title">
                            Contact No:
                            <input type="tel" id="center_tel" name="center_tel" class="form-field" value="<?php echo $result[0]->tel; ?>" required />
                        </div>
                        <div class="form-title">
                            email:
                            <input type="email" id="center_mail" name="center_mail" class="form-field" value="<?php echo $result[0]->mail; ?>" required/>
                        </div>

                    </div>
                    <div class="form-container" style="float: left; margin-left: 20px"> <div class="form-title">
                            Web Address:
                            <input type="url" id="center_web" name="center_web" class="form-field" value="<?php echo $result[0]->web; ?>" />
                        </div>
                        <div class="form-title">
                            Add your treatment areas here: 
                            <input class="form-field" type="text" id="autocomplete-field" placeholder="Type treatment area name here" style="margin-bottom: 2px;"/>

                            <textarea name="center_fields" class="form-field" id="autocomplete-field-pool" rows="6" ><?php
                        ...
                        <div class="form-title">
                            Description:
                            <textarea class="form-field" id="center-desc" name="center_desc" rows="4" cols="25" ><?php echo $result[0]->desc; ?></textarea>
                        </div>
            ...
            echo base_url();
            echo 'index.php/login\'>Login as an Admin</a> to </h3><h3 class=\'error\'>Edit Center Details</h3>';
        }
        ?>
    </div>
